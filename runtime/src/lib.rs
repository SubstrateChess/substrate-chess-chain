...
pub use frame_support::{
	...
	traits::{
		tokens::AssetId, ConstU128, ConstU32, ConstU64, ConstU8, KeyOwnerProofSystem, Randomness, StorageInfo, AsEnsureOriginWithArg
	},
	weights::{
...
parameter_types! {
	pub const BulletPeriod: u32 = 10;
	pub const BlitzPeriod: u32 = 50;
